...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Previo 8 Arely Olvera", nullptr, nullptr);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light.diffuse"), 0.3f, 1.0f, 1.0f);
        ...
        // Set material properties 2
        
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.ambient"), 2.0f, 2.0f, 2.0f);
        ...
        // Para dibujar el modelo del perro 
        glm::mat4 model(1);
        ...
        //Para dibujar el modelo del conejo
        glm::mat4 modelCon(1);

        modelCon = glm::mat4(1); 
        modelCon = glm::translate(modelCon, glm::vec3(3.0f, 0.0f, 0.0f)); // Mover a la derecha
        modelCon = glm::scale(modelCon, glm::vec3(3.0f, 3.0f, 3.0f));
